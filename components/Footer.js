            ...
            <UserAgentProvider ua={ua}>
                    ...
                    <div className="main-container">
                        <div className="footer">        
                            <div className="footer-item">
                                ...
                                <Pane paddingTop={5}>
                                    <span className="cursor" onClick={() => Router.push('/about')}>About</span>                          
                                </Pane>
                            </div>
                            <div className="footer-item">            
                                <Pane 
                                ...
                                >
                                    ...
                                    <Pane textAlign="center" alignItems="center" display="flex" flexDirection="row">
                                        ...
                                        <Pane marginRight={20}>
                                            <div className="cursor">
                                                <a className="sociallogo" href="https://www.facebook.com/lndieLink/" target="_blank">
                                        ...
                                        <Pane >
                                            <div className="cursor">
                                                <a className="sociallogo" href="https://github.com/CianOShea/IndieLink" target="_blank">
                            ...
                            <div className="footer-item">                    
                                <Pane paddingTop={5}>
                                    <span className="cursor" onClick={() => this.setState({ isShown: true })}>Contact</span>                          
                                </Pane>
                            </div>
                            <div className="copyright">
                                <Pane borderTop>
                                    <span>&#169;</span> 2020 Copyright: Cian O'Shea
                                </Pane> 
                            </div>                                   
                        </div> 
                        <Dialog
                        ...
                        >
                            <Pane
                                ...
                                display="flex"
                            >
                                <Heading textAlign='center' marginTop={10} size={900} marginBottom={20}>Contact</Heading>
                                <svg width="233.35" height="41.2" viewBox="0 0 233.35 41.2" fill="none">
                                    <g>
                                ...
                                <Heading textAlign='center' size={700} marginTop="default" marginBottom={20}>Please email:</Heading>
                                <Heading textAlign='center' size={900} marginBottom={10}>cian@indielink.io</Heading>  
                            </Pane>                           
                        </Dialog>
                    </div>
                </UserAgent>
                ...
                <div className="main-container">
                        <div className="footer">       
                            ...
                            <div className="copyright">
                                <Pane marginLeft={135} textAlign="center" alignItems="center" display="flex" flexDirection="row">
                                    <Pane marginRight={20}>
                                        <div className="cursor">
                                            <a className="sociallogo" href="https://twitter.com/theIndieLink" target="_blank">
                                                <FontAwesomeIcon size="2x" icon={faTwitter} /> 
