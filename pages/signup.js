...
import { Pane, TextInput, Text, Button, toaster, Heading } from 'evergreen-ui'
                        ...
                        <div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">                            
                            <form className="login100-form validate-form">
                                ...
                                <div className="wrap-input100 validate-input m-b-23" data-validate = "Name is required">
                                    ...
                                    <input className="input100"  type='name' placeholder='Full Name' name='name' value={name} onChange={e => this.onChange(e)}/>
                                ...
                                <div className="wrap-input100 validate-input" data-validate="Password is required">
                                    <span className="label-input100">Re-Type Password</span>
                                    <input className="input100" type='password' placeholder='Password' name='password2' value={password2} onChange={e => this.onChange(e)}/>
                                    <span className="focus-input100" data-symbol="&#xf190;"></span>
                                </div>
