...
class dashboard extends Component {
    ...
    static async getInitialProps(query, user, posts, profiles, profile, teams, markdowns) {
        ...
        return { ua: query.req ? query.req.headers['user-agent'] : navigator.userAgent, user, posts, profiles, profile, teams, markdowns, followingprofiles }
      }
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            link: '[Link Text](http://www.youtube.com/)'
        }
    };    
    ...
    render() {
        const { link, following } = this.state
